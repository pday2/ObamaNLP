...
# python the_featurizer.py Data amrhet datetitle.csv
# python the_featurizer.py Top10 topten datefiles_topten.csv
import pandas as pd
import numpy as np
import spacy
...
def main():
    ...
    # extra cleaning as necessary
    # lemmatize text with spacy
    #nlp_spacy = spacy.load("en_core_web_md", exclude=["parser", "ner"])
    #for i, doc in enumerate(nlp_spacy.pipe(speeches)):
    ...
    text_df.to_csv('tidy_data_'+suffix+'.csv')    
